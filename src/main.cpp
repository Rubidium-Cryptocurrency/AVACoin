...
static const int64 nTargetTimespan = 10*30; // Litecoin: 10 minute
static const int64 nTargetSpacing = 1* 30; // Litecoin: 30 minutes
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "AVACoin- nex payment systom of the world!!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x9"));
        block.print();
        assert(hash == hashGenesisBlock);
		// i enter new file star here ============================>
